    ...
    public class Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder){
                ...
                if(!optionsBuilder.IsConfigured){
                    ...
                    //  Data Source=DESKTOP-289EKCI\SQLEXPRESS02; 
                ...
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-289EKCI\\SQLEXPRESS02; Initial Catalog = Blibliotec_mvc; User Id=sa; Password=123; TrustServerCertificate = true");
